# Generated by Django 2.0.4 on 2018-05-25 15:45
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='DiseaseVaccinationday',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('number', models.IntegerField()),
                ('days_after_birth', models.IntegerField()),
                ('disease', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='service_development.Disease')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.IntegerField(default=0)),
                ('disease', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='service_development.Disease')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='service_development.KasaDakaUser')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('batch', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='service_development.Batch', verbose_name='Batch')),
                ('disease', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='service_development.Disease', verbose_name='Disease')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_name', models.BooleanField(default=True, help_text='The user will be asked to speak their name as part of the user registration process', verbose_name='Register spoken name')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(help_text="The voice label that asks the user to confirm their input. Example: 'Is this correct? Press 1 to confirm, or press 2 to retry.'", null=True, on_delete=django.db.models.deletion.PROTECT, related_name='ask_confirmation', to='service_development.VoiceLabel', verbose_name='Ask Confirmation'),
        ),
        migrations.AddField(
            model_name='language',
            name='ask_name',
            field=models.ForeignKey(help_text='The voice label used to ask user for their name', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='language_ask_name', to='service_development.VoiceLabel', verbose_name='Ask name'),
        ),
        migrations.AddField(
            model_name='language',
            name='ask_submit_batch',
            field=models.ForeignKey(help_text="The voice label that is played when the system asks user to submit a batch. Example: 'To make use of our vaccination reminder service, please press 1 to register your newborn chicken batch. Press 2, to end this call.'", null=True, on_delete=django.db.models.deletion.PROTECT, related_name='language_ask_submit_batch', to='service_development.VoiceLabel', verbose_name='Ask to submit batch'),
        ),
        migrations.AddField(
            model_name='language',
            name='batch_days_ago',
            field=models.ForeignKey(help_text="The voice label that is played when the system asks the user how many days ago the batch was born. Example: 'How many days ago was this new chicken batch born? Enter a number of days ago.'", null=True, on_delete=django.db.models.deletion.PROTECT, related_name='language_batch_days_ago', to='service_development.VoiceLabel', verbose_name='Batch days ago'),
        ),
        migrations.AddField(
            model_name='language',
            name='did_not_hear',
            field=models.ForeignKey(help_text="The voice label that is played when the system does not recognize the user saying anything. Example: 'Sorry, I didn't hear anything.", null=True, on_delete=django.db.models.deletion.PROTECT, related_name='language_did_not_hear', to='service_development.VoiceLabel', verbose_name='Did not hear'),
        ),
        migrations.AddField(
            model_name='language',
            name='eight',
        ...
        migrations.AddField(
            model_name='language',
            name='end_call',
            field=models.ForeignKey(help_text="The voice label that is played before ending the call. Example: 'Thank you for using our program. This call will now be ended.'", null=True, on_delete=django.db.models.deletion.PROTECT, related_name='language_end_call', to='service_development.VoiceLabel', verbose_name='End call'),
        ),
        migrations.AddField(
            model_name='language',
            name='error_message',
        ...
        migrations.AddField(
            model_name='language',
            name='final',
            field=models.ForeignKey(help_text="The voice label that is played when the user has completed the recording process. Example: 'Thank you for registering for our service! Your account has been created.'", null=True, on_delete=django.db.models.deletion.PROTECT, related_name='language_final', to='service_development.VoiceLabel', verbose_name='Final'),
        ),
        migrations.AddField(
            model_name='language',
            name='five',
        ...
        migrations.AddField(
            model_name='language',
            name='repeat',
            field=models.ForeignKey(help_text="The voice label that is played before the system repeats the user input. Example: 'Your name is:'", null=True, on_delete=django.db.models.deletion.PROTECT, related_name='language_repeat', to='service_development.VoiceLabel', verbose_name='Repeat'),
        ),
        migrations.AddField(
            model_name='language',
        ...
        migrations.AddField(
            model_name='language',
            name='thank_you_submitted',
            field=models.ForeignKey(help_text="The voice label that is played after reporting a new chicken batch. Example: 'Thank you, your new chicken batch is submitted. For today, you should vaccinate this new batch immediately with PESTOS against Newcastle Disease. For the other vaccinations, we will send you a reminder 2 days before the vaccination day.'", null=True, on_delete=django.db.models.deletion.PROTECT, related_name='language_thank_you_submitted', to='service_development.VoiceLabel', verbose_name='Batch is submitted + first advice'),
        ),
        migrations.AddField(
            model_name='language',
            name='three',
        ...
        migrations.AddField(
            model_name='language',
            name='welcome_user',
            field=models.ForeignKey(help_text="The voice label that is played to welcome the user to the program. Example: 'Hello farmer! Welcome to VP: our chicken vaccination program.'", null=True, on_delete=django.db.models.deletion.PROTECT, related_name='language_welcome_user', to='service_development.VoiceLabel', verbose_name='Welcome user'),
        ),
        migrations.AddField(
            model_name='language',
            name='zero',
        ...
        migrations.AddField(
            model_name='kasadakauser',
            name='name_voice',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='service_development.SpokenUserInput'),
        ),
        migrations.AddField(
            model_name='kasadakauser',
            name='service',
        ...
        migrations.AddField(
            model_name='batch',
            name='user',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='service_development.KasaDakaUser', verbose_name='User'),
        ),
        migrations.CreateModel(
            name='Choice',
            fields=[
